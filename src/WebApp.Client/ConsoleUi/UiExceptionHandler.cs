...
public sealed class UiExceptionHandler(ILogout logout) : IUiExceptionHandler
{
    ...
    public async Task<bool> TryHandleAsync(Exception exception, CancellationToken cancellationToken = default)
    {
        ...
        {
            _console.WriteLine(mustLogin.Message);
            return true;
        }
        ...
        {
            _console.WriteLine(string.Format(AppConstants.Messages.ErrorFormat, notFound.Message));
            return true;
        }
        ...
        {
            _console.WriteLine(string.Format(AppConstants.Messages.ErrorFormat, conflict.Message));
            return true;
        }
        ...
        {
            _console.WriteLine(string.Format(AppConstants.Messages.ErrorFormat, badRequest.Message));
            return true;
        }
        ...
        {
            _console.WriteLine(string.Format(AppConstants.Messages.ApiErrorFormat, (int)apiException.StatusCode, apiException.Message));
            return true;
        }
        ...
        {
            _console.WriteLine(string.Format(AppConstants.Messages.ErrorFormat, argumentException.Message));
            return true;
        }
        ...
        {
            _console.WriteLine(string.Format(AppConstants.Messages.ErrorFormat, invalidOperation.Message));
            return true;
        }
